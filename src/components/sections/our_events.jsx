      ...
      <div className='our-events flex flex-col lg:flex-row gap-8 mt-10 '>
        {ourEvents.map((event, index) => {
          return (
            <div
              key={index}
              className='rounded-3xl shadow-xl items-center w-full flex flex-col gap-8 pb-8'
            >
              <div
                className={`bg-cover bg-center w-full h-40 rounded-t-3xl flex justify-center items-center ${
                  index == 0
                    ? "bg-hackit-background-image"
              ...
              <div className='px-14 flex flex-col w-full gap-4'>
                ...
                <div className='grid lg:grid-cols-2'>
                  <div className='flex flex-row gap-3'>
                    ...
                    <p className='text-gray-400'>
                      {i18n.t(event.participants_prompt)}
                    </p>
                  </div>
                  <div>
              ...
              <div className='px-8 flex grow justify-self-end'>
                <LinkButton
                  ...
                  href={event.cta_link}
                  target='blank'
                  className='w-40 self-end h-max text-center'
                  text={i18n.t(event.cta_prompt)}
                />
              </div>
            </div>
          );
