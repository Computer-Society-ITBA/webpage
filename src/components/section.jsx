...
function Section (props) {
    ...
    const sizeMobile = props.sizeMobile === 'half' ? 'w-full h-screen-half' : (props.sizeMobile === 'almost' ? 'h-screen-3/4 w-full' : (props.sizeMobile === 'third' ? 'h-screen-third w-full' :'h-screen w-full'))
